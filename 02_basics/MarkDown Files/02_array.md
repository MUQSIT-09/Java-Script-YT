...
// The dc_heros becomes a different array within the marvel_heros array, forming a 2D array
...
// Array.isArray Method checks whether a value is an array
console.log(Array.isArray("Hitesh")) // false
console.log(Array.from("Hitesh")) // [ 'H', 'i', 't', 'e', 's', 'h' ]
console.log(Array.from({name: "hitesh"})) // interesting case, returns an empty array

// Array.of Method creates an array from given values
let score1 = 100
let score2 = 200
let score3 = 300
