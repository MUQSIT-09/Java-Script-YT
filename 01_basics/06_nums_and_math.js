...
// console.log(Math.abs(-4));
 ...
 Math.ceil(4.2) // Output - 5 (gives top value) // ceil takes the upperbound if 4.2 gives us 5
 Math.floor(4.9) // Output - 4 (gives bottom value) // floor takes the lowerbound if 4.9 gives us 4
...
// Gives value from 0-1 but doesn't reach 1, there are total 16 digits after decimal point.
// some times when the number is 0.01 so at that time 0 number can come so that's why we do +1.
